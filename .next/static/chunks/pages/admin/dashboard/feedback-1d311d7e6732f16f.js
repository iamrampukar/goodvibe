...
to {
  ...
  opacity: 1;
    ...
    forwards;
`,Y=({toast:e})=>{let{icon:t,type:s,iconTheme:r}=e;return void 0!==t?"string"==typeof t?o.createElement(X,null,t):t:"blank"===s?null:o.createElement(R,null,o.createElement(U,{...r}),"loading"!==s&&o.createElement(B,null,"error"===s?o.createElement(H,{...r}):o.createElement(q,{...r})))},V=e=>`
